        ...
        <div class="card mb-3">  
          ...
          <div class="card-body" id="search_card" class="collapse">
            ...
            <br>';
              ...
              $lines = file('uncategorized_keyword.txt', FILE_IGNORE_NEW_LINES);
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                          <input type="checkbox" name="van_hoa" value="yes">   Văn hóa xã hội   </input>
                        </div>
                        <div class="col-md-3">
                          <input type="checkbox" name="cong_nghe" value="yes">   Khoa học công nghệ   </input>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                            <input type="checkbox" name="quoc_phong" value="yes">   An ninh quốc phòng   </input>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" name="suc_khoe" value="yes">   Sức khỏe Đời sống   </input>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" name="giai_tri" value="yes">   Thể thao giải trí   </input>
                        </div>
                        <div class="col-md-3">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                              <input type="checkbox" name="dia_phuong" value="yes">   Địa phương   </input>
                        </div>
                        <div class="col-md-3">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                              <input type="checkbox" name="tac_pham" value="yes">   Tác phẩm   </input>
                        </div>
                        <div class="col-md-3">
                        </div>
                        <div class="col-md-3">
